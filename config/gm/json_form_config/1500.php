...
return [
    ...
    ["name" => "rule", "field" => "rule", "valType" => "array", "val" => [
        ...
        ["name" => "turnplate_fish_gold", "field" => "turnplate_fish_gold", "val" => null, "valType" => "string", "re" => trim('转盘鱼转盘金币')],
        ["name" => "turnplate_fish_percent", "field" => "turnplate_fish_percent", "val" => null, "valType" => "string", "re" => trim('转盘鱼奖励权重')],
        ["name" => "red_packets_fish", "field" => "red_packets_fish", "val" => null, "valType" => "string", "re" => trim('红包鱼奖励')],
        ["name" => "red_packets_fish_percent", "field" => "red_packets_fish_percent", "val" => null, "valType" => "string", "re" => trim('红包鱼概率%')],
