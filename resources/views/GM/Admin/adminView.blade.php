                    ...
                    <div classs="card">
                        ...
                        <div class="card-header">
                            <div class="btn-group v-search-bar" id="divSearch">
                                <input type="username" class="form-control" data-field="username" placeholder="{{ __('ts.username') }}" />
                ...
                <div class="modal-body">
                    <form class="">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" data-field="ip_white" style="min-height: 100px;"></textarea>
                        </div>
...
<script>
    ...
    $('.autors').click(function() {
        ...
        $(this).parent().parent().find('input').val(randomString(8))
    ...
    $(function() {
        ...
        common.getAjax(apiPath + "getbasedata?requireItems=lockType,bindGoogleCodeType,roleType", function(a) {
            typeData = a.result
