                    ...
                    <div classs="card">
                        ...
                        <div class="card-header">
                            ...
                            <div id="toolbar" class="select">
                                <!-- <div class="export btn-group" data-type="zip">
                                    <button class="btn btn-secondary" aria-label="Export" type="button" title="Export data">
...
<script>
    ...
    $(function() {
        ...
        var requireItems = 'gameAliasType,customerType'
        common.getAjax(apiPath + "getbasedata?requireItems=" + requireItems, function(a) {
            ...
            $("#client_id").select2()
            $("#game_id").select2()
            $("#btnSearch").initSearch(apiPath + "apidata/datareport", getColumns(), {
                sortName: "count_date",
                sortOrder: 'desc',
                showRefresh: true,
                showColumns: true,
