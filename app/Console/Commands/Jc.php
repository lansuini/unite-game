...
class Jc extends Command
{
    ...
    {
        $num = 0;
        $ts1 = require base_path('resources/lang/en/jc.php');
        $ts2 = require base_path('resources/lang/zh-cn/jc.php');
        foreach ($keys as $k) {
        ...
        file_put_contents(base_path('resources/lang/zh-cn/jc.php'), '<?php return ' . var_export($ts2, true) . ';');
        file_put_contents(base_path('resources/lang/en/jc.php'), '<?php return ' . var_export($ts1, true) . ';');
    }
    ...
    protected function dirs()
    {
        return [
            ...
            base_path('config/gm/json_form_config/4510.php'),
