...
//        ["name" => "five_flower_bomb", "field" => "five_flower_bomb", "val" => null, "valType" => "integer", "re" => trim('五花炸弹牛的倍数')],
//        ["name" => "five_flower_full_house", "field" => "five_flower_full_house", "val" => null, "valType" => "integer", "re" => trim('五花葫芦的倍数')],
//        ["name" => "five_flower_three_kind", "field" => "five_flower_three_kind", "val" => null, "valType" => "integer", "re" => trim('五花三条的倍数')],
//        ["name" => "five_flower_two_pair", "field" => "five_flower_two_pair", "val" => null, "valType" => "integer", "re" => trim('五花两对的倍数')],
        ["name" => "bonus_rate", "field" => "bonus_rate", "val" => null, "valType" => "integer", "re" => trim('奖池比例:奖池来源为每局系统当局盈利(税收)的比例设置(千分比)')],
        ["name" => "five_flower_bomb_bonus_rate", "field" => "five_flower_bomb_bonus_rate", "val" => null, "valType" => "integer", "re" => trim('五花炸弹牛获得奖池比例')],
        ["name" => "five_flower_full_house_bonus_rate", "field" => "five_flower_full_house_bonus_rate", "val" => null, "valType" => "integer", "re" => trim('五花葫芦获得奖池比例')],
        ["name" => "five_flower_three_kind_bonus_rate", "field" => "five_flower_three_kind_bonus_rate", "val" => null, "valType" => "integer", "re" => trim('五花三条获得奖池比例')],
        ["name" => "five_flower_two_pai_bonus_rater", "field" => "five_flower_two_pai_bonus_rater", "val" => null, "valType" => "integer", "re" => trim('五花两对获得奖池比例')],
        ["name" => "bonus_lowest_trigger_gold", "field" => "bonus_lowest_trigger_gold", "val" => null, "valType" => "integer", "re" => trim('奖池最低触发金额(分)')],
