...
return [
    ["name" => "rule", "field" => "rule", "valType" => "array", "val" => [
        ...
        ["name" => "SpecialBetArea", "field" => "SpecialBetArea", "val" => "0", "valType" => "select", "re" => trim('特殊下注区域(分)'), "options" => [
            100 => 100,
            500 => 500,
            1000 => 1000,
            2000 => 2000,
        ...
        ["name" => "robot_bet_special_max", "field" => "robot_bet_special_max", "val" => "0", "valType" => "integer", "re" => trim('特殊区域机器人最大下注,单位：分')],
    ]],
