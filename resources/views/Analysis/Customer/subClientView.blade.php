                ...
                <div class="modal-body">
                    <form class="">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control client_id" data-field="customer_id" readonly></select>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="">
                        <div class="form-group">
                            <label class="col-form-label">{{ __('ts.Client') }}</label>
                            <select class="form-control client_id" data-field="customer_id"></select>
                        </div>
...
<script>
    ...
    function showEditModal(data) {
        cform.get('editModal', apiPath + 'customer/subclient/' + data['id'] , function(res) {
    ...
    function delAccount(id) {
        myConfirm.show({
            ...
            sure_callback: function() {
                cform.del(apiPath + "customer/subclient/" + id, function(d) {
    ...
    common.getAjax(apiPath + "getbasedata?requireItems=lockType,customerAPIType1,customerType", function(a) {
            typeData = a.result
            ...
            $("#btnSearch").initSearch(apiPath + "customer/subclient", getColumns(), {
                sortName: "id",
                sortOrder: 'desc'
            })
        ...
        $('#updateBtnSubmit').click(function() {
            ...
            cform.patch('editModal', apiPath + 'customer/subclient/' + id, function(d) {
        ...
        $('#createBtnSubmit').click(function() {
            cform.post('createModal', apiPath + 'customer/subclient')
        })
