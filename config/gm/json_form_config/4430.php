...
return [
    ["name" => "rule", "field" => "rule", "valType" => "array", "val" => [
        ...
        ["name" => "nomal_control", "field" => "nomal_control", "val" => null, "valType" => "integer", "re" => trim('第三方挡位控制')],

        ["name" => "bill_types", "field" => "bill_types", "val" => null, "valType" => "integer", "re" => trim('统计流水方式 0按输赢 1按押注 2按输赢不扣税')],
        ["name" => "WinGoldHorseLimit", "field" => "WinGoldHorseLimit", "val" => null, "valType" => "integer", "re" => trim('赢家赢取xx金币播放跑马灯消息 普通环节(分)')],
